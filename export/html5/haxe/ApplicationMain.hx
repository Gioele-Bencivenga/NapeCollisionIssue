...
class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("HaxeFlixelGame", create);

		#if (js && html5)
		#if (munit || utest)
		lime.system.System.embed("HaxeFlixelGame", null, 640, 480);
		#end
		#else
		create(null);
		#end
	...
	public static function create(config):Void
	{
		...
		app.meta["file"] = "HaxeFlixelGame";
		app.meta["name"] = "HaxeFlixelGame";
